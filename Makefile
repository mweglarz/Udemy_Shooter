...
Shooter-Linux-Debug:
	 $(PROJECTBUILD) Shooter Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Shooter-Linux-DebugGame:
	 $(PROJECTBUILD) Shooter Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Shooter-Linux-Shipping:
	 $(PROJECTBUILD) Shooter Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Shooter-Linux-Test:
	 $(PROJECTBUILD) Shooter Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Shooter:
	 $(PROJECTBUILD) Shooter Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShooterEditor-Linux-Debug:
	 $(PROJECTBUILD) ShooterEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShooterEditor-Linux-DebugGame:
	 $(PROJECTBUILD) ShooterEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShooterEditor-Linux-Shipping:
	 $(PROJECTBUILD) ShooterEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShooterEditor-Linux-Test:
	 $(PROJECTBUILD) ShooterEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShooterEditor:
	 $(PROJECTBUILD) ShooterEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
