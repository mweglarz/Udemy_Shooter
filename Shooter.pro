...
include(ShooterSource.pri)
include(ShooterHeader.pri)
include(ShooterConfig.pri)
include(ShooterIncludes.pri)
include(ShooterDefines.pri)
...
Shooter-Linux-Debug.commands = $$build Shooter Linux Debug  -project="\"$$gameProjectFile\"" $$args
Shooter-Linux-DebugGame.commands = $$build Shooter Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Shooter-Linux-Shipping.commands = $$build Shooter Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Shooter-Linux-Test.commands = $$build Shooter Linux Test  -project="\"$$gameProjectFile\"" $$args
Shooter.commands = $$build Shooter Linux Development  -project="\"$$gameProjectFile\"" $$args

ShooterEditor-Linux-Debug.commands = $$build ShooterEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ShooterEditor-Linux-DebugGame.commands = $$build ShooterEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ShooterEditor-Linux-Shipping.commands = $$build ShooterEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ShooterEditor-Linux-Test.commands = $$build ShooterEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ShooterEditor.commands = $$build ShooterEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Shooter-Linux-Debug \
	Shooter-Linux-DebugGame \
	Shooter-Linux-Shipping \
	Shooter-Linux-Test \
	Shooter \
	ShooterEditor-Linux-Debug \
	ShooterEditor-Linux-DebugGame \
	ShooterEditor-Linux-Shipping \
	ShooterEditor-Linux-Test \
	ShooterEditor \
